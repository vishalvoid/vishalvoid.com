...
const SidebarNavLink: React.FC<SidebarNavLinkProps> = ({
  ...
  const classes = `relative group flex items-center p-2 md:p-3 text-sm md:text-base transition-colors duration-150 ${
    isActive
  ...
  const iconClasses = `w-4 h-4 md:w-5 md:h-5 mr-3 transition-colors ${
